          ...
          {earningsData.map((item, i) => (
            <ScrollReveal key={item.label} delay={i * 0.1}>
              <motion.div
                ...
                className="glass rounded-2xl p-5 lg:p-7 text-center hover:neon-glow transition-shadow group card-3d cursor-default"
              >
                ...
                <div className={`font-heading font-bold text-3xl lg:text-4xl ${item.color} leading-none mb-1`}>
                  {item.metric}
                </div>
